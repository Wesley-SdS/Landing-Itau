...
import PhotoIcon from '@/assets/icon-phone.svg'
            ...
            <Container>
                <div className="flex-1 max-w-[594px] pt-32">
                    ...
                    <ul className="flex flex-col items-start gap-9">
                        ...
                        <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                            <div className="w-7 h-7 flex justify-center">
                                <Image src={SoluctionsIcon} alt="Solutions" />
                            </div>
                            <p className="flex-1 text-txt-gray pr-2">
                        ...
                        <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                            ...
                            <p className="flex-1 text-txt-gray pr-2">
                                Acompanhe a fatura do seu cartão de crédito e faça compras online com o seu cartão virtual.
                            </p>
                        </li>
                    </ul>
                </div>
